...
The **scaffold-rfc** skill opens a new RFC as a draft PR, ready for the user
...
```mermaid
flowchart LR
  scaffold["🤖<br/><b>scaffold-rfc</b>"]:::agentic
...
These skills handle process, not substance: how an RFC is scaffolded, decided,
